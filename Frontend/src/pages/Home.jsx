...
import Swiper from './Concertswiper'
...
export default function Home() {
  ...
  return (
    <>
      <div className="pt-20 p-9 bg-brand-bg min-h-screen text-brand-text">
        <h1 className="text-2xl font-bold  text-brand-text">最近場次</h1>
        <Swiper />
      </div>
      <div className=" p-3 bg-brand-bg min-h-screen text-brand-text">
